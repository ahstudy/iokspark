...
public class SendPicSelectActivity extends Activity {
	...
	private Handler handler = new Handler(){
		...
		{
			if (msg.what==1){
				dialog = new ProgressDialog(SendPicSelectActivity.this);
				//设置进度条风格，风格为圆形，旋转的 
				...
				//ChatActivity.listMsg.add(null);
				Toast.makeText(SendPicSelectActivity.this, "头像更新成功", Toast.LENGTH_LONG).show();
				//if (!daysparkmess.equals("") && daysparkmess!=null){
				//	dayspark.setText(daysparkmess);
				//}
				dialog.cancel();
				SendPicSelectActivity.this.finish();
			}else if(msg.what==3){
				Toast.makeText(SendPicSelectActivity.this, "头像更新失败", Toast.LENGTH_LONG).show();
				//if (!daysparkmess.equals("") && daysparkmess!=null){
				//	dayspark.setText(daysparkmess);
				//}
				dialog.cancel();
